...
from invoicing import signals as invoicing_signals, QUOTATION_STATES
...
class Quotation(InvoiceBase, InvoiceMakableMixin, SearchDocumentMixin):
    ...
    def make_purchase_order(self, issuer):
        ...
        invoicing_signals.post_make_purchase_order.send(self.__class__, document=self, new_document=purchase_order)
        return purchase_order

    @classmethod
    def post_make_purchase_order(cls, sender, document, new_document, **kwargs):
        """
        ...
        """
        # Add timeline and notification entries
        post_make_purchase_order_task.delay(document, new_document)
